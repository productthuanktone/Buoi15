...
class Application extends Bootstrap
{
    ...
    {
        header("location: /Buoi15/" . strtolower($this->default_controller) . $this->suffix);
    }
public function goaddcus()
    {
        header("location: /Buoi15/customer/add" . strtolower($this->default_controller) . $this->suffix);
    }
    public function goLogin()
    {
        header("location: /Buoi15/user/login.html");
    }
